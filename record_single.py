...
dataset = tf.data.TFRecordDataset("./data/queries_samples/13")
...
loss = tf.multiply(1000., tf.losses.mean_squared_error(prediction, tf.reshape(y, (1,1)))) # pass the second value 
...
with tf.Session() as sess:
    ...
    for i in range(EPOCHS):
        ...
        if loss_value > 100 and i > EPOCHS*0.75:
    ...
    save_path = saver.save(sess, "./data/models/simple_net.ckpt_13")
    # Test model
